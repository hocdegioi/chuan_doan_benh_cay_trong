...
# --- GIAO DIỆN DUY NHẤT ---
# file_uploader trên mobile tự động hiện 2 tùy chọn: "Choose file" hoặc "Take photo"
uploaded_file = st.file_uploader("📂 Nhấn vào đây để Tải ảnh hoặc Chụp ảnh trực tiếp", type=["jpg", "jpeg", "png"])

if uploaded_file is not None:
    image = Image.open(uploaded_file)
    st.image(image, use_column_width=True)
    
    with st.spinner("Đang phân tích bệnh..."):
        # Xử lý ảnh
